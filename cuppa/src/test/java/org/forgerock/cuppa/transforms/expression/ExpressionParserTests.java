...
public class ExpressionParserTests {
    ...
    public void testNot() {
        ...
        Condition condition = ((NotCondition) expression).condition;
        assertThat(condition).isInstanceOf(ContainsCondition.class);
        assertThat(((ContainsCondition) condition).tag).isEqualTo("a");
    }
    ...
    public void testComplex() {
        ...
        Condition condition = ((NotCondition) andConditions.get(1)).condition;
        assertThat(condition).isInstanceOf(ContainsCondition.class);
        assertThat(((ContainsCondition) condition).tag).isEqualTo("e");
